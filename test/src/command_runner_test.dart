...
void main() {
  group('OpenciRunnerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late OpenciRunnerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = OpenciRunnerCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = OpenciRunnerCommandRunner();
