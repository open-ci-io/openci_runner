    ...
    return _then(_value.copyWith(
      androidBuildNumber: null == androidBuildNumber
          ...
          : androidBuildNumber // ignore: cast_nullable_to_non_nullable
              as int,
      androidKeyJks: null == androidKeyJks
          ? _value.androidKeyJks
          : androidKeyJks // ignore: cast_nullable_to_non_nullable
              as String,
      androidKeyProperties: null == androidKeyProperties
      ...
      firebaseAppDistributionTesters: null == firebaseAppDistributionTesters
          ...
          : firebaseAppDistributionTesters // ignore: cast_nullable_to_non_nullable
              as List<String>,
      firebaseAppIdAndroid: null == firebaseAppIdAndroid
...
class _$UserDataImpl implements _UserData {
  ...
  @override
  List<String> get firebaseAppDistributionTesters {
    if (_firebaseAppDistributionTesters is EqualUnmodifiableListView)
      return _firebaseAppDistributionTesters;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_firebaseAppDistributionTesters);
  }
  ...
  List<String> get triggerBranches {
    if (_triggerBranches is EqualUnmodifiableListView) return _triggerBranches;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_triggerBranches);
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.androidKeyJks, androidKeyJks) ||
            ...
            (identical(
                ...
                other.appStoreConnectIssuerId == appStoreConnectIssuerId) &&
            (identical(other.appStoreConnectKeyId, appStoreConnectKeyId) ||
            ...
            (identical(other.firebaseAppIdAndroid, firebaseAppIdAndroid) ||
