...
import 'package:openci_dashboard/src/features/top/presentation/top_controller.dart';
...
class TopPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final controller = ref.watch(topControllerProvider.notifier);
    return Scaffold(
      appBar: AppBar(
  ...
  List<Widget> list(UserData userData, TopController controller) {
    return [
      TextFormField(
