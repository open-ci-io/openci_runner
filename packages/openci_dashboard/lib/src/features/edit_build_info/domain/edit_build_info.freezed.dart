...
EditBuildInfo _$EditBuildInfoFromJson(Map<String, dynamic> json) {
  return _Top.fromJson(json);
}

/// @nodoc
mixin _$EditBuildInfo {
  ...
  @JsonKey(ignore: true)
  $EditBuildInfoCopyWith<EditBuildInfo> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EditBuildInfoCopyWith<$Res> {
  factory $EditBuildInfoCopyWith(
          EditBuildInfo value, $Res Function(EditBuildInfo) then) =
      _$EditBuildInfoCopyWithImpl<$Res, EditBuildInfo>;
  @useResult
  $Res call(
...
/// @nodoc
class _$EditBuildInfoCopyWithImpl<$Res, $Val extends EditBuildInfo>
    implements $EditBuildInfoCopyWith<$Res> {
  _$EditBuildInfoCopyWithImpl(this._value, this._then);
...
class __$$TopImplCopyWithImpl<$Res>
    extends _$EditBuildInfoCopyWithImpl<$Res, _$TopImpl>
...
class _$TopImpl implements _Top {
  ...
  @override
  String toString() {
    return 'EditBuildInfo(androidBuildNumber: $androidBuildNumber, joinedOrgs: $joinedOrgs, selectedOrg: $selectedOrg, userData: $userData)';
  }
...
abstract class _Top implements EditBuildInfo {
  const factory _Top(
      {final int androidBuildNumber,
